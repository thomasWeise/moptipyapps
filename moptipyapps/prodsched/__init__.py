...
In this package, we provide instance data structures, instance generators, and
a simulator for production scheduling problems. The goal is to emulate the
works of Thürer et al. [1] and beyond, in a way that can be plugged into
